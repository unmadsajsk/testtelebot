from config import *
import requests,telebot,random,os
import telebot
...
def boten(message):
    ...
    M = types.InlineKeyboardButton('المطور', url='https://t.me/knk_1k')
...
if __name__ == "__main__":
    bot.remove_webhook()
    bot.set_webhook(url='https://testbottelebot.herokuapp.com/'+str(BOT_TOKEN))
